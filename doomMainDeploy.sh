...
_EOF_
    ...
    lpDo cp -r /bisos/blee/doom-emacs-framework/* /bisos/blee/27f/doom-blee-main
    lpDo cp /bisos/blee/doom-blee-init/init.el /bisos/blee/27f/doom-blee-main
    lpDo cp /bisos/blee/doom-blee-init/early-init.el /bisos/blee/27f/doom-blee-main
